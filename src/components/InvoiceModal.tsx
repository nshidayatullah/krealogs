...
@media screen and (max-width: 820px) {
  ...
  .inv-root { transform-origin: top center; transform: scale(0.55); width: 100% !important; min-height: auto !important; margin-bottom: -200px !important; }
  .inv-root + .inv-root { margin-top: -200px !important; }
}
...
@media screen and (max-width: 500px) {
  .inv-root { transform: scale(0.42); margin-bottom: -280px !important; }
