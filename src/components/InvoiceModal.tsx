...
const S: Record<string, React.CSSProperties> = {
  ...
  signImg: { height: 140, marginBottom: -40, objectFit: "contain", opacity: 0.85, display: "block", marginLeft: "auto", marginRight: "auto" },
...
.inv-stamp-img { position: absolute; top: 50%; left: 55%; transform: translate(-50%, -50%) rotate(-15deg); height: 160px; opacity: 0.2; pointer-events: none; z-index: 6; }
@media print {
