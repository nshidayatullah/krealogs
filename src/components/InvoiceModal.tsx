      ...
      <div className="relative w-full max-w-4xl overflow-hidden bg-zinc-950 rounded-2xl shadow-2xl border border-zinc-850 flex flex-col max-h-[95vh]">
        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-900 bg-zinc-950 text-white no-print">
          <div className="flex items-center space-x-2">
            <span className="px-2.5 py-1 text-xs font-sans font-bold rounded bg-zinc-900 text-zinc-300 border border-zinc-800">
              {booking.id}
            </span>
          ...
          >
            ...
            {booking.status === "paid" ? (
              ...
              >
                ...
                <div className="border-4 border-double border-emerald-600/85 text-emerald-650 px-6 py-2 rounded-2xl flex flex-col items-center bg-white/40 shadow-sm">
                  <span className="text-[10px] font-sans font-black tracking-[0.2em] opacity-80 leading-none">KREALOGS</span>
                  ...
                  <span className="text-[9px] font-sans font-bold tracking-wider leading-none">ESTD 2025</span>
                </div>
              </div>
              ...
              >
                <div className="border-4 border-double border-amber-600/85 text-amber-650 px-5 py-2.5 rounded-2xl flex flex-col items-center bg-white/45 shadow-sm">
                  <span className="text-[9px] font-sans font-black tracking-widest opacity-85 leading-none">KREALOGS</span>
                  ...
                  <span className="text-[8px] font-sans font-bold tracking-wider leading-none">BOOKING CONFIRMED</span>
                </div>
              </div>
            ) : null}
            ...
            <div className="space-y-6 relative z-10">
                ...
                <div className="text-left sm:text-right space-y-1 sm:max-w-xs">
                  ...
                  <div className="mt-2 inline-block w-full sm:w-64 border border-zinc-950 text-xs font-sans">
                    <div className="flex border-b border-zinc-950">
                      <div className="w-24 bg-zinc-100 font-semibold p-1.5 border-r border-zinc-950 uppercase text-[10px] tracking-wider shrink-0 text-left">
                        {booking.status === "paid" ? "KWITANSI NO" : "INVOICE NO"}
                      </div>
                      <div className="p-1.5 font-sans font-bold text-zinc-900 text-left truncate flex-1">
              ...
              <div className="grid grid-cols-2 gap-x-8 text-xs font-sans pb-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-zinc-650 font-sans text-[11px]">
                ...
                <table className="w-full border border-zinc-950 border-collapse text-xs font-sans">
                  ...
                  <tbody>
                    {tableItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* QTY CELL */}
                          <td className="border-r border-zinc-950 p-2.5 text-center align-top font-sans font-medium text-neutral-900">
                            {item.qty}
                          </td>

                          {/* TOTAL CELL */}
                          <td className="border-r border-zinc-950 p-2.5 text-right align-top font-sans font-medium text-neutral-900">
                          ...
                          {/* DISCOUNT CELL */}
                          <td className="p-2.5 text-center align-top font-sans font-medium text-neutral-600">
                            {item.discount}
                          </td>
                        </tr>
                      );
                    ...
                    <tr>
                      ...
                      <td 
                        className="p-2.5 text-right font-bold font-sans text-[11px] bg-[#FFC000] text-neutral-950"
                      >
                    ...
                    {discountAmount > 0 && (
                      <tr>
                        ...
                        <td 
                          className="p-2.5 text-right font-bold font-sans text-[11px] bg-[#E2EFDA] text-emerald-800"
                        >
                    ...
                    <tr>
                      ...
                      <td 
                        className="p-2.5 text-right font-bold font-sans text-[11px] bg-[#FCE4D6] text-neutral-950"
                      >
                        -
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td 
                        className="p-2.5 text-right font-black font-sans text-xs bg-[#F47B20] text-white"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-10 mt-6 border-t border-zinc-150 relative z-10">
              ...
              <div className="space-y-1.5 text-xs text-zinc-900 text-left">
                ...
                <div className="space-y-0.5 leading-relaxed text-[11px] text-zinc-800">
                  ...
                  <p className="font-sans bg-zinc-100 border border-zinc-200 rounded px-1.5 py-0.5 inline-block text-[11px] text-neutral-900 font-bold my-0.5">
                ...
                {booking.amountPaid < booking.totalPrice && (
                  <div className="mt-4 p-2.5 bg-rose-50 border border-rose-200/50 rounded-xl text-[10px] space-y-1">
                    ...
                    <div className="grid grid-cols-2 gap-x-2 text-zinc-600 font-sans">
              ...
              <div className="flex flex-col items-end justify-center relative pr-4 min-h-36">
                ...
                <div className="absolute right-12 top-1 w-24 h-24 rounded-full border border-indigo-400/20 bg-indigo-50/10 flex items-center justify-center opacity-30 select-none pointer-events-none">
                  <div className="w-20 h-20 rounded-full border border-dashed border-indigo-500/20 flex flex-col items-center justify-center">
                    <span className="text-[6px] font-sans tracking-widest text-indigo-750 font-black">ESTD 2025</span>
                    <span className="text-lg font-black text-indigo-800">K</span>
                    <span className="text-[6px] font-sans tracking-widest text-indigo-750 font-black">KREALOGS</span>
                  </div>
                </div>
            ...
            <div className="mt-6 pt-4 border-t border-zinc-200 text-center">
              ...
              <span className="text-[8px] text-zinc-400 block max-w-lg mx-auto leading-normal">
                Harap simpan salinan invoice ini sebagai bukti pemesanan penugasan resmi tim videografer. Semua syarat dan ketentuan berlaku sebagaimana didaftarkan via platform Krealogs.com.
              </span>
            </div>
        ...
        <style>{`
          @media print {
            ...
            body > div, #root, #root > div { display: block !important; background: none !important; position: static !important; overflow: visible !important; }
            .fixed.inset-0 { position: static !important; background: none !important; padding: 0 !important; }
            .fixed.inset-0 > div { max-height: none !important; background: none !important; border: none !important; box-shadow: none !important; overflow: visible !important; }
            #printable-invoice {
              width: 210mm; min-height: 297mm; padding: 12mm !important; margin: 0 auto !important;
              background: #fff !important; color: #000 !important; border: none !important; box-shadow: none !important;
