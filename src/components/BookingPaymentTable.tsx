      ...
      <div className="flex flex-wrap items-center gap-3 justify-between bg-zinc-950/30 p-2.5 rounded-xl border border-zinc-900">
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            ...
            className="bg-zinc-950 border border-zinc-800 rounded-lg text-[11px] text-zinc-300 py-1.5 px-2.5 focus:outline-none focus:border-emerald-500/50 transition cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center justify-center p-1.5 bg-zinc-900 border border-zinc-800 rounded-lg text-zinc-400 hover:text-white hover:border-emerald-500/50 transition cursor-pointer"
          >
            {sortDir === "asc" ? (
